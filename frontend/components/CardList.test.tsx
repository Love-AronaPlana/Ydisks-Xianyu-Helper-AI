...
vi.mock('../app/features/cards/hooks', /* cardsHooksMockFactory 提供卡密库存和批量 Hook 替身。 */ () => ({
...
vi.mock('../app/features/cards/api', /* cardsApiMockFactory 提供卡密页面动作 API 替身。 */ () => ({
  createCard: cardListMocks.createCard,
  deleteCard: cardListMocks.deleteCard,
  updateCard: cardListMocks.updateCard,
}));

vi.mock('../app/features/cards/components/BatchCardImportModal', /* batchModalMockFactory 提供批量弹窗替身。 */ () => ({
