...
func (r *AccountSettingsRepository) UpdateSettings(ctx context.Context, input accountapp.SettingsUpdateInput) (int64, error) {
	...
	databaseInput := db.AccountSettingsUpdate{
		...
		AutoConfirm: input.AutoConfirm, AutoConsign: input.AutoConsign, AutoBargain: input.AutoBargain, CaptchaBrowserMode: input.CaptchaBrowserMode, PauseDuration: input.PauseDuration,
