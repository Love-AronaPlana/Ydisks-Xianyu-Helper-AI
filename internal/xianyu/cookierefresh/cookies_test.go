...
// TestMetadataSnapshotKeyCompatibility 负责TestMetadataSnapshotKeyCompatibility相关处理。
func TestMetadataSnapshotKeyCompatibility(t *testing.T) {
	// oldMeta 保存oldMeta，供当前处理流程使用
...
// TestCookieHeaderForURLScopesDomainPathAndSecure 负责Test登录凭证HeaderForURLScopesDomain路径AndSecure相关处理。
...
// TestCookieHeaderForURLOrdersLongerPathFirst 负责Test登录凭证HeaderForURL订单列表Longer路径First相关处理。
...
// TestCookieHeaderForURLKeepsCreationOrderForEqualPaths 负责Test登录凭证HeaderForURLKeepsCreation订单ForEqualPaths相关处理。
...
// TestScopedCookieHeaderDistinguishesEmptySnapshotFromUnavailable 负责TestScoped登录凭证HeaderDistinguishesEmptySnapshotFromUnavailable相关处理。
...
// TestApplySetCookiesPreservesAttributesAndDeletesExactScope 负责TestApplySetCookiesPreservesAttributesAndDeletesExactScope相关处理。
...
// TestApplySetCookiesAcceptsDomainAttributeWithoutLeadingDot 负责TestApplySetCookiesAcceptsDomainAttributeWithoutLeadingDot相关处理。
...
// TestApplySetCookiesMaxAgeOverridesExpires 负责TestApplySetCookiesMaxAgeOverridesExpires相关处理。
...
// TestApplySetCookiesReplacementAndRecreationOrder 负责TestApplySetCookiesReplacementAndRecreation订单相关处理。
func TestApplySetCookiesReplacementAndRecreationOrder(t *testing.T) {
	...
	// recreated 保存recreated，供当前处理流程使用
...
// TestApplySetCookiesRejectsUnrepresentablePartitionedCookie 负责TestApplySetCookiesRejectsUnrepresentablePartitioned登录凭证相关处理。
...
// TestApplySetCookiesEnforcesSameSiteAndCookiePrefixes 负责TestApplySetCookiesEnforcesSameSiteAnd登录凭证Prefixes相关处理。
...
// TestSameNameCookiesKeepScopeAndPartitionIdentity 负责TestSame名称CookiesKeepScopeAndPartitionIdentity相关处理。
func TestSameNameCookiesKeepScopeAndPartitionIdentity(t *testing.T) {
	...
	// reconciled 保存reconciled，供当前处理流程使用
...
// TestSynthesizedSnapshotsRemainDeterministic 负责TestSynthesizedSnapshotsRemainDeterministic相关处理。
func TestSynthesizedSnapshotsRemainDeterministic(t *testing.T) {
	// fromFlat 保存fromFlat，供当前处理流程使用
...
// TestSnapshotMetadataReportsAuthoritativeEmptyAndPreservesPartitionKey 负责TestSnapshotMetadataReportsAuthoritativeEmptyAndPreservesPartitionKey相关处理。
...
// TestChangedSnapshotLabels 负责TestChangedSnapshotLabels相关处理。
