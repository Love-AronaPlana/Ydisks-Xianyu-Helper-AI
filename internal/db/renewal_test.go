...
// TestUpdateRenewalCookieEncryptsCookieAndMetadataAtRest 负责TestUpdateRenewal登录凭证Encrypts登录凭证AndMetadataAtRest相关处理。
func TestUpdateRenewalCookieEncryptsCookieAndMetadataAtRest(t *testing.T) {
	...
	// rawCookie、rawMetadata 保存原始Cookie、rawMetadata，供当前处理流程使用
...
// TestUpdateRenewalCookieRejectsMissingAccount 负责TestUpdateRenewal登录凭证RejectsMissing账号相关处理。
...
// TestFlatCookieUpdateClearsSnapshotAndPreservesOtherMetadata 负责TestFlat登录凭证UpdateClearsSnapshotAndPreservesOtherMetadata相关处理。
...
// TestEncryptLegacySecretsMigratesCookieMetadata 负责TestEncryptLegacySecretsMigrates登录凭证Metadata相关处理。
